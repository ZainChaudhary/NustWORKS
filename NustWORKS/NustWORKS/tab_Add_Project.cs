...
namespace NustWORKS
{
    public partial class tab_Add_Project : UserControl
    {
        public static tab_Add_Project _instance;
        public static tab_Add_Project Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new tab_Add_Project();
                return _instance;

            }
        }
        public tab_Add_Project()
        {
            InitializeComponent();
        }
